...
<div class="col-l">
    ...
    <div class="box">
        <div class="clearfix tab-optseach">
            <ul class="tab1 clearfix">
                ...
                <li class="active"><a title="Soi cầu 2 nháy" href="<?php echo Url::createUrl("soicau/hainhay"); ?>"><strong>Soi cầu 2 nháy</strong></a></li>
        ...
        <form method="GET" action="<?php echo Url::createUrl("soicau/hainhay"); ?>">
    ...
    <div class="box">
        <div class="title-bor">
            <h2 class="s18">Soi cầu 2 nháy <?php echo $province_list[$province_id]['name']; ?> - cầu <?php echo $bien_do_ngay; ?> ngày</h2>
