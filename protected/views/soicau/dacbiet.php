...
<div class="col-l">
    ...
    <div class="box">
        <div class="clearfix tab-optseach">
            <ul class="tab1 clearfix">
                <li class=""><a title="Soi cầu loto" href="<?php echo Url::createUrl("soicau/index"); ?>"><strong>Soi cầu loto</strong></a></li>
                <li class="active"><a title="Soi cầu đặc biệt" href="<?php echo Url::createUrl("soicau/dacbiet"); ?>"><strong>Soi cầu đặc biệt</strong></a></li>
        ...
        <form method="GET" action="<?php echo Url::createUrl("soicau/dacbiet"); ?>">
            <ul class="clearfix opt-soicau">
                ...
                <li class="in-block">
                    ...
                    <select name="bien_do_ngay">
                        <option <?php if($bien_do_ngay ==2) echo 'selected=""';  ?>  value="2">2 ngày</option>
    ...
    <div class="box">
        <div class="title-bor">
            <h2 class="s18">Soi cầu đặc biệt <?php echo $province_list[$province_id]['name']; ?> - cầu <?php echo $bien_do_ngay; ?> ngày</h2>
