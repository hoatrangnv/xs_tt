...
<div class="col-l">
    ...
    <div class="box">
        <div class="clearfix tab-optseach">
            <ul class="tab1 clearfix">
                ...
                <li class="active last"><a title="Soi cầu bạch thủ" href="<?php echo Url::createUrl("soicau/bachthu"); ?>"><strong>Soi cầu bạch thủ</strong></a></li>
            </ul>
        </div>
        <div class="box">
        ...
        <form method="GET" action="<?php echo Url::createUrl("soicau/bachthu"); ?>">
    ...
    <div class="box">
        <div class="title-bor">
            <h2 class="s18">Soi cầu bạch thủ <?php echo $province_list[$province_id]['name']; ?> - cầu <?php echo $bien_do_ngay; ?> ngày</h2>
