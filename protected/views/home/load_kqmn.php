...
<ul class="gr-yellow clearfix">
    ...
    <?php foreach($provinces as $value){?>
        <li>
            <a title="Xổ số <?php echo $value["name"];?>" href="<?php echo Url::createUrl("result/miennam",array("province_name"=>$value["alias"],"code"=>$value["code"],"province_id"=>$value["id"]))?>" title="">
...
<div class="loto-city dd_<?php echo $ngay_quay;?>" style="display: none;">
    <p class="txt-center s18 cl-org"><strong>Bảng Loto xổ số Miền Nam - Ngày: <?php echo date('d/m/Y',strtotime($ngay_quay))?></strong></p>
    <?php foreach($provinces as $value){?>
        <div class="col125">
