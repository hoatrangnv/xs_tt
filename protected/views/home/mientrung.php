    ...
    <div class="box-kq">
        <div class="box">
            ...
            <h1 class="title-bor mag0">
                <strong>
                    <?php 
                        if($action!="index"){
                            echo "Kết quả xổ số miền trung hôm nay";
                        }else{
            ...
            <div class="clearfix tab-optseach">
                <ul class="tab1 clearfix" id="areas_result">
                    ...
                    <li class="active"><a title="Xổ số miền trung" href="<?php echo Url::createUrl("home/mientrung")?>"><strong>Miền Trung</strong></a></li>
            ...
            <?php
                if(date('N',time())==4||date('N',time())==6){
                    $class = "three"; 
                }else{
                    $class = "two";
                }
            ...
            <div class="<?php echo $class_tuongthuat;?>"  id="load_kq_mt">
                <?php 
        ...
        <div class="conect_out pad5">    
            <?php 
                ...
                if(date('H')!=LoadConfig::$region["mt"]["hour_live"]){
                    $this->renderPartial("application.views.layouts.social_home");
                }
            ?>
            <?php $url_print = Url::createUrl("print/index",array("region"=>2,"ngay_quay"=>isset($ngay_quay) ? date('d-m-Y',strtotime($ngay_quay)):date('d-m-Y',time())))?>     
        ...
        <?php $this->renderPartial("application.views.module.result_yesterday",array("region"=>2))?>
...
<script type="text/javascript">
    ...
    function loadKetquaMientrung(strUrl){
        $.ajax({
            ...
            data: {},
            beforeSend : function(){
                var text = $("#load_kq_mt").html();
                $("#load_kq_mt").html(text);
            },
    ...
    function loadMientrung(){ 
        ...
        $(document).ready(function(){
            <?php if(date('H',time())==LoadConfig::$region["mt"]["hour_live"]){?>
            loadMientrung();
            setInterval(
                function(){
                    loadMientrung();
