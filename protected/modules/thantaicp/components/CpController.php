...
{  
    ...
    public function getBreadcrumbs(){
        ...
        $str = '<li><a href="'.Yii::app()->baseUrl.'/thantaicp"><span class="home1">Trang quản trị</span></a></li>';
    ...
    {              
        ...
        if(in_array(Yii::app()->getModule('thantaicp')->user->name, array("admin", "thangtt", "vietbq"))){
            return true;
        }
        ...
        if(Yii::app()->getModule('thantaicp')->user->isGuest){
            ...
            $data_admin = AdminUser::getDataById(Yii::app()->getModule('thantaicp')->user->id);
            if(!$data_admin || $data_admin["status"]=="reject"){
                Yii::app()->getModule("thantaicp")->user->logout();
            }
            ...
            if($check == 1){
                ...
                if(Yii::app()->getRequest()->getIsAjaxRequest()){ 
                    ...
                    $this->render("application.modules.thantaicp.views.home.no_permit");exit;
                }
    ...
    public function checkPermit($controller,$action){
        $adminId = Yii::app()->getModule('thantaicp')->user->id;
        $module_id = 0;
        $permission_name = "";
