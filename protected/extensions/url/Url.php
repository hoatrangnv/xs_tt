...
class Url extends CUrlManager {
    ...
    public function createUrlRv($route, $params = array(), $ampersand = '&') {
        $urlRaovat = Yii::app()->params->urlRaovat; 
       ...
       $url=str_replace($url_base,$urlRaovat,$url);
       //echo "cuoi: ".$url;
      // exit();
       return $url; 
    
    }
	public function createUrlMyaz($route, $params = array(), $ampersand = '&') {
        $urlMyaz = Yii::app()->params->urlMyaz; 
       //$url_base=str_replace('index.php','myaz/',$this->getBaseUrl());
       $url_base = Yii::app()->baseUrl;
       if($route=='')
         return  $urlMyaz;
       ...
       $url=str_replace($url_base,$urlMyaz,$url);
       //echo "cuoi: ".$url;
      // exit();
       return $url; 
