...
class CommonDB{
    ...
    static public function insertRowOther($connect,$table,$arr_params){
        $arr_type = CommonDB::$arr_type;
        $field = "";
        $field_value = "";
        foreach($arr_params as $key=>$value){
        ...
        $result = $command->execute();
        $last_id = $connect->getLastInsertId();
        return $last_id;
    }
    ...
    static public function updateRowOther($connect,$table,$arr_params,$arr_key_field){
        $arr_type = CommonDB::$arr_type;
        $field = "";
        $field_where = "";
        foreach($arr_params as $key=>$value){
...
//            echo $sql;die;
    ...
    static public function deleteRowOther($connect,$table,$arr_params){
        $params = "";
        foreach($arr_params as $key=>$value){
            $params .= " AND ".$key." = '".$value."' ";
        }
